...
public ResponseEntity<String> addQuestion(@RequestParam("question") String questionText,@RequestParam("answer") String questionAnswer){
 javaQuestionService.add(questionText,questionAnswer);
 return ResponseEntity.ok("Вопрос добавлен");
}

@GetMapping("exam/java/remove")
public ResponseEntity<String> removeQuestion(@RequestParam("question") String questionText,@RequestParam("answer") String questionAnswer){
